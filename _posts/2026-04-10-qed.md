...
I'm excited to open-source [QED](https://github.com/proofQED/QED), a multi-agent pipeline I built with [Qihao Ye](mailto:q8ye@ucsd.edu), [Minghao Pan](mailto:mpan2@caltech.edu), and [Jiayun Zhang](mailto:landiveo@gmail.com) that takes a mathematical problem statement in LaTeX and produces a rigorous natural-language proof. QED has already solved a research-level open problem in partial differential equations, with the proof verified by domain experts from three institutions.
