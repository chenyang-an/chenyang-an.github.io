...
The AI tools that participated in the proof include: **Gemini 2.0 Flash Thinking** and an unpublished Gemini-based tool called **FullProof** (likely a Gemini-based agent). The paper does not specify exactly how these two tools respectively contributed.
